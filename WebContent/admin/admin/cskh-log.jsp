...
<%	
	...
	String sAdmin = "'adminhn','adminhcm','admindn'";
		
	String sType = request.getParameter("type");
	if(sType==null)
		sType = "";	
	
	int tong = adminLogDAO.countAllCSKHLog(sAdmin, sType);
	...
	Collection cAdminLog = adminLogDAO.findAllCSKHLog(sAdmin, sType, currentPn, n);
 %>
<html >
<head>
...
<body>
	<div id="body-wrapper"><!-- Wrapper for the radial gradient background -->		
		...
		<div id="main-content"> <!-- Main Content Section with everything -->					
			...
			<div class="clear"></div>
			<h2 align="center">QUẢN LÝ CSKH LOG</h2>
							...
							<tfoot>
								<tr>
									<td colspan="6">
										...
										<%
										if(pn>1){
											String pageUrl = "cskh-logs.jsp?type="+sType+"&p=";
										%>
