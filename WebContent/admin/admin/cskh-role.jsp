...
<html >
	<head>
		...
		<title>Phân quyền account CSKH</title>
 ...
 %>
	...
	<div id="body-wrapper"> <!-- Wrapper for the radial gradient background -->
		...
		<div id="main-content"> <!-- Main Content Section with everything -->					
			...
			<h2 align="center">PHÂN QUYỀN CHO ACCOUNT CSKH</h2>
			<div class="clear"></div> <!-- End .clear -->
			...
			<div class="content-box"><!-- Start Content Box -->
				...
				<div class="content-box-header" style="padding-top: 5px;padding-left: 20px;">					
					<select id="slt_admin" name="slt_admin" onchange="retrieveURLAction('showCSKHRole.jsp',processStateChange);">
						<option value="">--Chọn account--</option>
						<%
							Collection cAdmin = adminDAO.getAll("", Admin.RIGHT_TELCO ,1,1000);
							String roleType = "";
								...
								for(Iterator it = cAdmin.iterator(); it.hasNext();){
									...
									if(objAdmin!=null){
										if(objAdmin.getRightRole() == Admin.RIGHT_ADMIN)
											...
											roleType = "Partner";
						%>
							<option <%if(admin.equals(objAdmin.getUserName())){ %> selected="selected" <%} %> value="<%=objAdmin.getUserName() %>"><%=objAdmin.getUserName() %> </option>
						<%
