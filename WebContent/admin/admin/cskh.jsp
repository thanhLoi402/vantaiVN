...
<title>Danh sách account chăm sóc khách hàng</title>
...
<%	
	...
	int tong = adminDAO.countAll(txtVar, Admin.RIGHT_TELCO);
	...
	Collection cAdmin = adminDAO.getAll(txtVar, Admin.RIGHT_TELCO ,currentPn,n);
 ...
 %>
 		...
 		$(function(){
 			$("#btn-delete").click(function(){
 				if($('input[name="chkId"]:checked').length >0){
 					if(confirm('Bạn có muốn xóa những account đã được lựa chọn ko?')){
	...
	<div id="body-wrapper"> <!-- Wrapper for the radial gradient background -->
		...
		<div id="main-content"> <!-- Main Content Section with everything -->					
			...
			<h2 align="center">DANH SÁCH TÀI KHOẢN CSKH</h2>
			<div class="clear"></div> <!-- End .clear -->
			...
			<div class="content-box"><!-- Start Content Box -->
				...
				<div class="content-box-header" style="padding-top: 3px;">						
					...
					<span style="float: right;padding-right: 20px;"><input class="button" type="button" value="NEW..." onclick="window.location.href='add-cskh.jsp';"/></span>	
					<div class="clear"></div>
					...
					<div class="tab-content default-tab" id="tab1"> <!-- This is the target div. id must match the href of this div's tab -->
							<table cellpadding="4" cellspacing="4" border="1" rules="all" width="80%">
								<tr class="header" bgcolor="c6c6c6" align="center">
									...
									<td>STT</td>
									<td>
										<h3 style="font-size: 13px;">Tên truy cập</h3>
									</td>
									<%
										if(!adminIsTelco || adm_control.getUserName().equals("adm") ){
									%>
									<td>
										<h3 style="font-size: 13px;">Phân quyền</h3>
									</td>
									<%} %>
									<td>
										<h3 style="font-size: 13px;">Họ tên</h3>
									</td>
									<td>
										<h3 style="font-size: 13px;">SĐT</h3>
									</td>
									<td>
										<h3 style="font-size: 13px;">Email</h3>
									</td>
									<td>
										<h3 style="font-size: 13px;">Ip truy cập</h3>
									</td>
									<td style="text-align: center">
										<h3 style="font-size: 13px;">Trạng thái</h3>
									</td>
									
									<td>
										<h3 style="font-size: 13px;">Tùy chọn</h3>
									</td>
								</tr>
								<% 
									int index = 0;
									...
									while(ite.hasNext()){
										...
										if(admin!=null){
										index++;
										objRole = adminRoleDAO.getRole(admin.getUserName(), new BigDecimal(410));
								%>
								<tr class="list">
									<td>
									...
									%>
									<td>
										<a href="cskh-role.jsp?admin=<%=admin.getUserName()%>">chi tiết</a>
									</td>
									<%} %>
									<td>
									...
									<td>
										<a href="add-cskh.jsp?id=<%=admin.getId() %>"><img border="0" alt="" src="../login/resources/images/icons/pencil.png"/></a>
									</td>
								</tr>
							...
							<table cellpadding="4" cellspacing="4" border="0"  width="80%">
								<tr>
									...
									<td>
										...
										<%
										if(pn>1){
											String pageUrl = "cskh.jsp?txtVar1="+txtVar+"&p=";
										%>
