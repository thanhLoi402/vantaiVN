...
var fnCallbackAfterCalendar;
var oGlobalArray = [];

function fnInitCalendar(oTarget, sInputID, sCustom, fnCallback)
{
	...
	oTarget.onclick = function(e) {
		_fnSetCalendar(e, sInputID, sCustom, fnCallback);
		if(fnCallback)
			fnCallbackAfterCalendar = fnCallback;
		else
			fnCallbackAfterCalendar = '';
	};
}

function _fnSetCalendar(e, sInputID, sCustom, fnCallback)
{
	var oCalendarArray	= [];
...
function _fnGetCalendarMonth(iMonth)
{
	...
	/*
	oMonths.push('Th�ng 1');
	oMonths.push('Th�ng 2');
	oMonths.push('Th�ng 3');
	oMonths.push('Th�ng 4');
	oMonths.push('Th�ng 5');
	oMonths.push('Th�ng 6');
	oMonths.push('Th�ng 7');
	oMonths.push('Th�ng 8');
	oMonths.push('Th�ng 9');
	oMonths.push('Th�ng 10');
	oMonths.push('Th�ng 11');
	oMonths.push('Th�ng 12');
	*/
