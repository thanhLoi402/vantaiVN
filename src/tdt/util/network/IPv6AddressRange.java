...
public class IPv6AddressRange implements Comparable<IPv6AddressRange>, Iterable<IPv6Address>, Serializable
{
    ...
    /**
     * The natural order of {@link tdt.util.network.IPv6AddressRange}s orders them on increasing first addresses, and on increasing last
